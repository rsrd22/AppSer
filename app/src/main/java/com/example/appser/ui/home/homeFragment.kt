...
class homeFragment : Fragment(R.layout.fragment_home) {
    ...
    fun cargarPreguntas(){
        ...
        val preguntas = listOf (
            PreguntasEntity(0,"Siento un nudo en la  garganta o presión en el pecho.", 1,1,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Siento un nudo en la  garganta o presión en el pecho.", 1,2,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Me duele la cabeza constantemente.", 1,3,1,"SAdmin", "2022-05-03"),

            PreguntasEntity(0,"Me siento cansado físicamente a pesar de  haber dormido bien / me cuesta mucho moverme", 1,1,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Me duele la cabeza constantemente.", 1,2,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Aprieto los dientes o las manos.", 1,3,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Siento mucha energía en todo mi cuerpo", 1,4,1,"SAdmin", "2022-05-03"),


            PreguntasEntity(0,"Pienso que antes todo era mejor", 2,1,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Creo que no seré capaz de hacer algo.", 2,2,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Pienso que lo que me está pasando es injusto.", 2,3,1,"SAdmin", "2022-05-03"),
            ...
            PreguntasEntity(0,"Siento que lo que estoy viviendo no debería pasar.", 3,3,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Quisiera que todos sintieran lo que yo estoy sintiendo en este momento.", 3,4,1,"SAdmin", "2022-05-03"),

            PreguntasEntity(0,"Quiero estar solo.", 3,1,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Quiero estar solo.", 3,2,1,"SAdmin", "2022-05-03"),


            PreguntasEntity(0,"Quisiera que alguien viniera a decirme que todo estará bien.", 4,1,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Quiero huir/esconderme.", 4,2,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Quiero que alguien pague por algo que me ha hecho.", 4,3,1,"SAdmin", "2022-05-03"),
            PreguntasEntity(0,"Quiero salir y compartir con las personas de mi vida.", 4,4,1,"SAdmin", "2022-05-03"),
        )
    ...
    fun cargarActividades(){
        ...
        val actividades = listOf(
            ...
            ActividadesEntity(0,"Caja Misteriosa",
            ...
            ActividadesEntity(0,"Frecuencias",
            ...
            ActividadesEntity(0,"¡Hagamos Plastilina!",
            ...
            ActividadesEntity(0,"Diccionario de emociones",
            ...
            ActividadesEntity(0,"Compartir en familia",
            ...
            ActividadesEntity(0,"Caja de miedos",
            ...
            ActividadesEntity(0,"Vamos a casar un oso",
                " Leer el cuento \"Vamos a cazar un oso\" (Michael Rosen y Helen oxenbury) ",
                "",2,2,1,"SAdmin", "2022-05-03"),

            ActividadesEntity(0,"Técnica de la Tortuga",
            ...
            ActividadesEntity(0,"Veamos un video",
            ...
            ActividadesEntity(0,"El bote de lagrimas",
                ...
                "",1,3,1,"SAdmin", "2022-05-03"),
            ActividadesEntity(0,"La pócima mágica de los miedos",
            ...
            ActividadesEntity(0,"El semáforo",
            ...
            ActividadesEntity(0,"Burbujas para la Ira",
            ...
            ActividadesEntity(0,"Caja de Sonrisas","En familia tomar una cajita de carton o plastico y decorarla. Esta se llamara la cajita de sonrisas en papeles de colores escribir cada integrante de la familia anecdotas, situaciones, recuerdos, chistes, que les cause risa, alegria, felicidad, etc.; en cada papelito al respaldo se dibujara una sonrisa o dos depende del efecto generado en la familia.",
                "",4,3,1,"SAdmin", "2022-05-03"),
            ActividadesEntity(0,"Ruleta de la felicidad","Con ayuda de los padres construir una ruleta con cartulina,  los integrantes de la familia identifican acciones o actividades que generen o expresen alegria (abrazar, dar un elogio, hacer ejercicio etc). estas seran las opciones de la ruleta. al finalizar jugar con la ruleta y el integrante de la familia debera realizar la acción o actividad que propueve la alegria. ",
                "",4,3,1,"SAdmin", "2022-05-03"),


            ActividadesEntity(0,"Coloreando lo que siento (mándalas)",
            ...
            ActividadesEntity(0,"Cambiar significados: Diccionario de palabras molestas",
            ...
            ActividadesEntity(0,"Proyección: Mapa de sueños",
            ...
            ActividadesEntity(0,"Cuadros vivos collage",
            ...
            ActividadesEntity(0,"Meditación inversa",
            ...
            ActividadesEntity(0,"Cómo nos ven",
            ...
            ActividadesEntity(0,"Limpieza de espacios",
                ...
                "",3,5,1,"SAdmin", "2022-05-03"),
            ActividadesEntity(0,"Ruta de metas",
            ...
            ActividadesEntity(0,"Escribir un cuento",
            ...
            ActividadesEntity(0,"Mirarse al espejo",
            ...
            ActividadesEntity(0,"Respiración con la mano",
            ...
            ActividadesEntity(0,"Bolitas de colores",
