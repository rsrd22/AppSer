...
//        }
    ...
    fun cargarPreguntas() {
        ...
        val preguntas = listOf(
            ...
            PreguntasEntity(6, "Aprieto los dientes o las manos.", 1, 3, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(
                7,
            ...
            PreguntasEntity(8, "Pienso que antes todo era mejor", 2, 1, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(
                9,
            ...
            PreguntasEntity(11, "Creo que todo estará bien.", 2, 4, 1, "SAdmin", "${Instant.now().toString()}"),


            PreguntasEntity(12, "Siento que me hace falta algo.", 3, 1, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(13, "Me siento pequeño o frágil.", 3, 2, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(
                14,
            ...
            PreguntasEntity(16, "Quiero estar solo.", 3, 1, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(17, "Quiero estar solo.", 3, 2, 1, "SAdmin", "${Instant.now().toString()}"),
            ...
            PreguntasEntity(19, "Quiero huir/esconderme.", 4, 2, 1, "SAdmin", "${Instant.now().toString()}"),
            PreguntasEntity(
                20,
    ...
    fun cargarActividades() {
        ...
        val actividades = listOf(
            ...
            ActividadesEntity(
                ...
                "", 1, 1, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 2, 1, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 3, 1, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 4, 1, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 1, 2, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                "", 2, 2, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                3, 2, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "https://www.youtube.com/watch?v=3wcc_oIxX10", 4, 2, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 1, 3, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                "", 2, 3, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                14, "El semáforo",
                ...
                "", 3, 3, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                "", 1, 4, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                "", 2, 4, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 3, 4, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 4, 4, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 1, 5, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 2, 5, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                25, "Cómo nos ven",
                ...
                "", 3, 5, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
            ...
            ActividadesEntity(
                ...
                "", 4, 5, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ...
            ActividadesEntity(
                ...
                "", 1, 6, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                29, "Escuchar un cuento",
                "Escuchar el cuento: el círculo de los 99, Jorge Bucay",
                "https://www.youtube.com/watch?v=Kx24nncU2ZE", 1, 6, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                30, "La ruta",
                ...
                "", 2, 6, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 3, 6, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                32, "Organizar",
            ...
            ActividadesEntity(
                ...
                "", 4, 6, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                34, "Karaoke",
            ...
            ActividadesEntity(
                ...
                "", 1, 7, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                36, "Origami",
                ...
                "", 2, 7, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 3, 7, 1, "SAdmin", "${Instant.now().toString()}"
            ),
            ActividadesEntity(
                ...
                "", 4, 7, 1, "SAdmin", "${Instant.now().toString()}"
            ),
        )
    ...
    fun cargarEmociones() {
        ...
        val emociones = listOf(
            EmocionesEntity(1, "Tristeza", 1, "SAdmin", "${Instant.now().toString()}"),
            EmocionesEntity(2, "Miedo", 1, "SAdmin", "${Instant.now().toString()}"),
            EmocionesEntity(3, "Ira", 1, "SAdmin", "${Instant.now().toString()}"),
            EmocionesEntity(4, "Alegria", 1, "SAdmin", "${Instant.now().toString()}")
        )
    ...
    fun cargarCategorias() {
        ...
        val categorias = listOf(
            CategoriasEntity(1, "Fisico/Corporal", 1, "SAdmin", "${Instant.now().toString()}"),
            CategoriasEntity(2, "Cognitivo", 1, "SAdmin", "${Instant.now().toString()}"),
            CategoriasEntity(3, "Emocional", 1, "SAdmin", "${Instant.now().toString()}"),
            CategoriasEntity(4, "Social", 1, "SAdmin", "${Instant.now().toString()}"),
    ...
    fun cargarCiclos() {
        ...
        val ciclosVital = arrayOf(
            CicloVitalEntity(1, "2-3 AÑOS", 2, 3, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(2, "Infancia 4-6", 4, 6, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(3, "T. Infancia", 7, 12, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(4, "Adolescencia", 13, 19, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(5, "Adultez Temprana", 20, 39, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(6, "Adultez Media", 40, 59, 1, "SAdmin", "${Instant.now().toString()}"),
            CicloVitalEntity(7, "Adultez Tardía", 60, 140, 1, "SAdmin", "${Instant.now().toString()}"),

            )
        for(pos in ciclosVital.indices){
            Log.d("Ciclo pos", "posicion ${pos} ciclo ${ciclosVital.get(pos)}")
            viewModel.fetchSaveCicloVital(ciclosVital.get(pos)).observe(viewLifecycleOwner, Observer { result ->
                when (result) {
                    is Resource.Loading -> {
                        Toast.makeText(requireContext(), "Cargando..", Toast.LENGTH_SHORT).show()
                    }
...
//    }
    ...
    fun cargarRoles() {
        ...
        val roles = listOf(
            RolEntity(1, "Admin", 1, "SAdmin", "${Instant.now().toString()}"),
            RolEntity(2, "Usuario", 1, "SAdmin", "${Instant.now().toString()}")
        )
